...
class LayoutUtils {
    companion object {
        fun crossFade(viewToShow: View, viewToHide: View, duration: Int = 500) {//передаем 3 парам
            if (!viewToShow.isVisible) {// срабатываю анимации, подстветка и тп.
...
fun View.fadeIn(duration: Int = 500) {// анимация
    this.apply {
